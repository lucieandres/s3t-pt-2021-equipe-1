...
public class InterfaceRejoindrePartie extends InterfaceBase {
	...
	public GestionnaireInterfacePP GI = null; //Un lien vers l'instance principale de GestionnaireInterface est nécessaire pour revenir en arrière.
     ...
     * @since 1.0
     */
	public InterfaceRejoindrePartie(GestionnaireInterfacePP gi) {
		super();
		GI = gi;
		dessineInterface(GI);
	}
...
//-----------------Créations des composants------------------------------------------------        
        ...
        //Création du titre
      	Label Titre = new Label("rejoindre une partie");
      	...
      	Label TexteJoueur = new Label("nom");
      	...
      	Label TexteCode = new Label("code");
     	...
     	// Bouton jouer
     	Button boutonJouer = new Button("rejoindre");
