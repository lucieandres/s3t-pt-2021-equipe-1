...
public class InterfaceJeu extends InterfaceBase {
	...
	/**
     *  Ce constructeur permet de crÃ©er tous les Ã©lÃ©ments de l'interface, c'est-Ã -dire le bouton pour quitter, le bouton pour voir 
     *  les rÃ¨gles, le bouton pour aller le texte pour voir qui doit jouer, la grille des cartes du plateau et la main du joueur.
     * 
	...
	/**
     * Cette mÃ©thode permet de dessiner la grille de la partie pour jouer.
     * 
     * 
     * @param gi Le gestionnaire d'interface permettra de relier cette interface aux autres pour qu'elle puisse communiquer ensemble.
     * 
    ...
    /**
     * Cette mÃ©thode permet de dessiner la main du joueur.
     * 
     * 
    ...
    /**
     * Cette mÃ©thode permet de dessiner les colonnes.
     * 
     * 
     * @param data DonnÃ©es actuelles du jeu.
     * 
